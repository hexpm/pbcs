defmodule PKCS5.KeyManager do
  ...
  defp key_manager_module("PBES2-HS256"), do: {:ok, PKCS5.PBES2_HMAC_SHA2}
  defp key_manager_module("PBES2-HS384"), do: {:ok, PKCS5.PBES2_HMAC_SHA2}
  defp key_manager_module("PBES2-HS512"), do: {:ok, PKCS5.PBES2_HMAC_SHA2}
